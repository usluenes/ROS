...
# Brings in the same messages used by the CounterWithDelay action, including the
# goal message and the result message
from senspublisher.msg import CounterWithDelayAction, CounterWithDelayGoal, CounterWithDelayResult
...
def counter_with_delay_client():
    ...
    goal = CounterWithDelayGoal(num_counts = 20)
